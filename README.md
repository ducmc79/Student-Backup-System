...
![Cấu trúc thư mục](./images/thu_muc.png)

### 2. Kết quả chạy Script (Menu màu sắc)
![Kết quả chạy script](./images/script.png)

### 3. Cấu hình Cronjob (Tự động chạy mỗi 5 phút)
![Cấu hình Cronjob](./images/cronjob.png)

### 4. Giao diện Repository GitHub
![Repository GitHub](./images/github.png)
